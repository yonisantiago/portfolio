...
import NameChanger from '../utils/Hello';

import MiniRoomCanvas from "./workspace3d/SuperScene";
      ...
      >
        ...
        <div>
          <div>
            ...
            <NameChanger />
            I am <span className="text-[#915EFF]">Yoni</span>
            </h1>
          </div>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              I develop web applications, user <br className="sm:block hidden" />
              interfaces and WordPress websites
            </p>
          </div>
